...
{
    [AbpAuthorize(PermissionNames.Master_Roles)]
    public class RoleAppService : AsyncCrudAppService<Role, RoleDto, int, PagedRoleResultRequestDto, CreateRoleDto, RoleDto>, IRoleAppService
    {
        ...
        public async Task<PagedResultDto<RoleListDto>> GetRolesAsync(GetRolesInput input)
        {
            ...
            return new PagedResultDto<RoleListDto>(rolesCount, ObjectMapper.Map<List<RoleListDto>>(roles));
        }
        public async Task<PagedResultDto<RoleListDto>> GetRoles(GetRolesInput input)
        {
            var roles = await _roleManager
                ...
                .ToListAsync();
            return new PagedResultDto<RoleListDto>(2, ObjectMapper.Map<List<RoleListDto>>(roles));
        }
