...
{
    public class AccountGroupManager : DomainService, IAccountGroupManager
    {
        ...
        public async Task<IdentityResult> CreateAsync(AccountGroup entity)
        {
        ...
        public async Task<IEnumerable<AccountGroup>> GetAllList()
        {
        ...
        public async Task<IdentityResult> UpdateAsync(AccountGroup entity)
        {
            try
            {
