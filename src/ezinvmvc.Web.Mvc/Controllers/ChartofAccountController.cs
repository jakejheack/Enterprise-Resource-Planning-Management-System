...
{
    public class ChartofAccountController : ezinvmvcControllerBase
    {
        ...
        public class TreeGridItems
        {
            ...
            //public async Task<ActionResult> OnDemand()
            //{

            //    GetAccountListInput input = new GetAccountListInput();
            //    input.Filter = "UserId|" + (int)AbpSession.UserId;

            //    var account = await _accountService.GetAccounts(input);
            //    return View();
            //}
        }
    }
