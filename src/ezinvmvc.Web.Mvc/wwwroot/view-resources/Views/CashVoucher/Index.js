...
(function () {
    $(function () {
        ...
        var _$table = $('#CashVoucherTable');
        var _$table2 = $('#CashVoucherTable2');
        ...
        var dataTable = _$table.DataTable({
            ...
            searching: false,
            listAction: {
                ajaxFunction: _service.getAllCashVoucher,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    "render": function (data) {
                        return '<a id="view-journal" title="view" href="#" class="view-journal" data-journal-id="' + data.id + '" data-rfq-code="' + data.code + '">' + data.code + '</i></a>';
                    }
                },
                {
                    targets: 2,
                ...
                },
                {
                    ...
                    data: { id: "id" },
                    "render": function (data) {
                        //return '<a id="edit-journal" title="edit" href="#" class="edit-journal" data-journal-id="' + data.id + '" data-journal-code="' + data.code + '"  data-journal-status="' + data.status + '" data-toggle="modal" data-target="#ClientEditModal"  ><i class="fa fa-pencil-square-o"></i></a>|<a id="delete-rfq" title="delete" href="#" class="delete-rfq" data-rfq-id="' + data.id + '"><i class="fa fa-trash"></i></a>';
                        var edit = '<a id="edit-journal" title="edit" href="#" class="edit-journal" data-journal-id="' + data.id + '" data-journal-code="' + data.code + '"  data-journal-status="' + data.status + '" data-toggle="modal" data-target="#ClientEditModal"  ><i class="fa fa-pencil-square-o"></i></a>';
                        //var del = '<a id="delete-rfq" title="delete" href="#" class="delete-rfq" data-rfq-id="' + data.id + '"><i class="fa fa-trash"></i></a>';
                        var ret = '';
                        if (abp.auth.isGranted("Pages.CashVoucher.Edit")) {
                            ret += edit;
                        }
        ...
        // View record
        _$table.on('click', 'a.view-journal', function (e) {
            e.preventDefault();
            var Id = $(this).attr("data-journal-id");
            window.location.href = abp.appPath + 'CashVoucher/Details?id=' + Id;
        });
        ...
        _$table.on('click', 'a.edit-journal', function (e) {
            ...
            abp.message.confirm(
                ...
                function (isConfirmed) {
                    if (isConfirmed) {
                        window.location.href = abp.appPath + 'CashVoucher/Edit?id=' + Id;
                    }
                }
            );
        });
        ...
        $('#ExportToExcelButton').click(function (e) {
            e.preventDefault();
            tableToExcel('CashVoucherTable2', 'Cash Voucher', 'CashVoucher.xls');
        });
