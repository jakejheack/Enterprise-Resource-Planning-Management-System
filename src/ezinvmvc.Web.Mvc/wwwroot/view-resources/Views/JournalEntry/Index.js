...
(function () {
    $(function () {
        ...
        var _$table = $('#JournalEntryTable');
        var _$table2 = $('#JournalEntryTable2');
        ...
        var dataTable = _$table.DataTable({
            ...
            searching: false,
            listAction: {
                ajaxFunction: _service.getAllJournalEntry,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    "render": function (data) {
                        ...
                        var ret = '';
                        if (abp.auth.isGranted("Pages.Journal.Entry.Edit")) {
                            ret += edit;
                        }
        ...
        _$table.on('click', 'a.view-journal', function (e) {
            ...
            window.location.href = abp.appPath + 'JournalEntry/Details?id=' + Id;
        });
        ...
        $('#ExportToExcelButton').click(function (e) {
            e.preventDefault();
            tableToExcel('JournalEntryTable2', 'Journal Entry', 'JournalEntry.xls');
        });
