...
(function () {
    $(function () {
        ...
        var dataTable = _$AttadjTable.DataTable({
            ...
            "bInfo": false,
            listAction: {
                ajaxFunction: _payrollIServices.getSSSSummary,
        ...
        $('#ExportToExcelButton').click(function (e) {
            e.preventDefault();
            tableToExcel('AttadjTable', 'SSSSummaryTable', 'SSSSummaryReport.xls');
        });
        ...
        function printPreviewActual2() {
            ...
            win.document.write('<h4>SSS Payroll Summary Report</h4>');
