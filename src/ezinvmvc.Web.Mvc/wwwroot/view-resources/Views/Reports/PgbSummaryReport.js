...
(function () {
    $(function () {
        ...
        var dataTable = _$AttadjTable.DataTable({
            ...
            "bInfo": false,
            listAction: {
                ajaxFunction: _payrollIServices.getPgbSummary,
        ...
        function printPreviewActual2() {
            ...
            win.document.write('<h4>Pag-Ibig Summary Report</h4>');
        ...
        $('#ExportToExcelButton').click(function (e) {
            e.preventDefault();
            tableToExcel('AttadjTable', 'AttadjTable', 'PagibigSummaryReport.xls');
        });
