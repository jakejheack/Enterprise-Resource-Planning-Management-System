...
(function () {
    $(function () {
        ...
        var dataTable = _$Table.DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    orderData: 8,
                    targets: 5,
                    data: { defaultSource: "defaultSource", entryTypeId: "entryTypeId",defaultDestination: "defaultDestination", inventoryTypeId: "inventoryTypeId" },
                    "render": function (data) {
                        if (data.entryTypeId === 1) {
                            if (data.inventoryTypeId === 3) {
                ...
                },
                {
                    ...
                    "render": function (data) {
                        ...
                        var edit = '<a id="edit" title="details" href="#" class="edit" data-id="' + data.id + '"><i class="fa fa-lg fa-pencil-square-o"></i></a>';
                        ...
                        var ret = '';
                        if (abp.auth.isGranted("Pages.Stock.Entry.Edit")) {
                            ret += edit;
                        }
        ...
        $('#ExportToExcelButton').click(function (e) {
            e.preventDefault();
            tableToExcel('ListTable2', 'Stock Entry', 'StockEntry.xls');
        });
