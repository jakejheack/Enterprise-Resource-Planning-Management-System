    ...
    $(function () {
        ...
        function getsalesorder() {
            ...
            _salesOrderService.getSalesOrder({ id: $id }).done(function (result) {
                ...
                $('#StatusBadge').prop('class', '');
                $('#divRevReason').attr('hidden', 'hidden');
                switch (result.statusId) {
                    ...
                    case 7:
                        ...
                        $('#divRevReason').removeAttr('hidden');
                        break;
                    default:
                        $('#StatusBadge').addClass('badge badge-secondary');
                }
        ...
        function getRevisionNos() {
            ...
            var id = $('#Id').val();
            $revnos.empty();
            _salesOrderService.getSORevisions({ filter: code, sorting: "revisionno asc" }).done(function (result) {
